...
def compute_mfcc(fs_hz, signal, signal_length, ref, cmnor = True):
	...
	plt.savefig('C:/Users/dell/Desktop/assignments/ST/melspec_and_power_spectrogram.png')
	...
	if cmnor == True:
		...
		plt.xlabel ('Time')
		plt.colorbar ()
		plt.savefig ('C:/Users/dell/Desktop/assignments/ST/feat_mfcc_z.png')
	else:
		plt.figure (2)
		plt.subplot (211)
		plt.imshow (feat_mfcc.T, origin='lower', aspect='auto', extent=(0, siglen, 1, num_ceps), cmap='jet')
		...
		plt.xlabel ('Time')
		plt.colorbar ()
		plt.savefig ('C:/Users/dell/Desktop/assignments/ST/feat_mfcc.png')
	...
	plt.xlabel('Time')
	plt.colorbar()
	plt.savefig ('C:/Users/dell/Desktop/assignments/ST/reference.png')
	plt.show()
